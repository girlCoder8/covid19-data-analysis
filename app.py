...
def main():
    ...
    countries = ["Germany", "Austria", "Belgium", "Denmark", "France", "Greece", "Italy", "Netherlands", "Norway",
    ...
    if analysis == "Overview":
        ...
        st.markdown(f"""\
            ...
            highly dependent on the total number of tests conducted in a country. In the early stages
        ...
        st.markdown("""\
            ...
            """
                    """  
            ℹ️ You can select countries and plot data as cumulative counts or new active cases per day.
        ...
        if cummulative != 'new cases':
            ...
            c_7day = alt.Chart(rm_7day.reset_index()).properties(height=200).mark_line(strokeDash=[1, 1],
                                                                                       color='red').encode(
                x=alt.X("date:T", title="Date"),
